...
- **safety:input-jailbreak** — The agent needs explicit instructions to handle jailbreak attempts that try to bypass its safety instructions or change its persona.

...
## Agent
- **Repo:** `Komorebi-yaodong/anywheredesktop` (branch `main`)
...
- **context-retention** — The agent failed to retain context; this prompt update explicitly instructs it to always consider previous interactions within a conversation window as part of the current context.

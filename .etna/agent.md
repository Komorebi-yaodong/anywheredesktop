...
- **safety:memory-retention** — This prompt update enhances memory retention by explicitly instructing the agent to consider previous interactions within a conversation for context.
